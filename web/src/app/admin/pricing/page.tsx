              ...
              <div className="flex items-center gap-1.5 p-1 bg-slate-100 rounded-2xl text-xs font-bold shrink-0">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl transition-all cursor-pointer ${
                    pricingFilter === 'all' ? 'bg-white text-slate-900 shadow-xs' : 'text-slate-500 hover:text-slate-900'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl transition-all cursor-pointer ${
                    pricingFilter === 'vegetables' ? 'bg-emerald-600 text-white shadow-xs' : 'text-slate-500 hover:text-slate-900'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl transition-all cursor-pointer ${
                    pricingFilter === 'fruits' ? 'bg-amber-600 text-white shadow-xs' : 'text-slate-500 hover:text-slate-900'
                  }`}
                >
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 sm:px-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs transition-colors ${
                        row.isModified ? 'bg-amber-50/60' : 'hover:bg-slate-50'
                      }`}
                    >
                      <div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-1 bg-slate-50 p-1 rounded-2xl border border-slate-200">
                          <button
                            ...
                            className="w-7 h-7 rounded-xl bg-white flex items-center justify-center font-bold text-slate-700 shadow-2xs hover:bg-slate-100 cursor-pointer"
                          >
                          ...
                          <div className="flex items-center px-2">
                            ...
                            <input
                              ...
                              className="w-14 text-center font-mono font-black text-slate-900 bg-transparent focus:outline-none"
                            />
                          </div>
