...
export default function HomePage() {
  ...
  return (
    <div className="pb-28 sm:pb-16 bg-slate-50 dark:bg-slate-950 min-h-screen text-slate-900 dark:text-slate-100">
      ...
      {/* 📱 Mobile Ultra-Compact Hero Header (< sm) */}
      <section className="sm:hidden bg-gradient-to-r from-emerald-950 via-teal-950 to-emerald-950 text-white px-3.5 py-2.5 border-b border-emerald-800/40 shadow-xs">
        <div className="flex items-center justify-between gap-2">
          <div className="space-y-0.5 min-w-0">
            <h1 className="text-xs font-black tracking-tight text-white flex items-center gap-1 truncate">
              <span>🌿 તાજા ફળ અને શાકભાજી (Halol)</span>
            </h1>
      ...
      {/* 💻 Desktop Full Hero Banner (>= sm) */}
      <section className="hidden sm:block bg-gradient-to-b from-emerald-800 via-teal-900 to-emerald-950 text-white relative overflow-hidden py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight leading-tight">
            ...
            <span className="block text-emerald-300 text-xl font-semibold mt-1">
