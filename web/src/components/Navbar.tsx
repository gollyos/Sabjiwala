...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800 shadow-xs">
      ...
      <div className="bg-emerald-950 text-emerald-100 text-xs px-4 py-1.5 font-medium flex items-center justify-between overflow-x-auto border-b border-emerald-800/40">
        ...
        <div className="hidden sm:flex items-center space-x-3 text-emerald-300 shrink-0">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          {user && isOnboarded && customer ? (
            <button
              ...
              className="flex items-center space-x-2 px-3 sm:px-4 py-2 rounded-2xl bg-emerald-50 dark:bg-emerald-950/80 hover:bg-emerald-100 dark:hover:bg-emerald-900 border border-emerald-200 dark:border-emerald-800 text-emerald-950 dark:text-emerald-100 font-semibold text-xs transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3.5 py-2 rounded-2xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-bold text-xs transition-all cursor-pointer border border-slate-200/60 dark:border-slate-700"
            >
          ...
          <button
            ...
            className="relative flex items-center space-x-2 px-4 py-2.5 rounded-2xl bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white font-black text-xs sm:text-sm shadow-md shadow-emerald-600/30 transition-all cursor-pointer"
          >
            <ShoppingBag className="w-4 h-4" />
            <span className="hidden sm:inline">Basket</span>
            {totalItemCount > 0 && (
              <span className="px-2 py-0.5 rounded-full bg-white text-emerald-800 font-black text-xs shadow-xs">
                {totalItemCount}
              </span>
            )}
          </button>
